...
export const COMP_MAPS: readonly CompMap[] = [
  { id: 'birnin-tchalla', name: "Birnin T’Challa", mode: 'Domination', boardMapId: 'birnin-tchalla-domination' },
  { id: 'hells-heaven', name: "Hell’s Heaven", mode: 'Domination', boardMapId: 'hells-heaven-domination' },
  ...
  { id: 'museum-of-contemplation', name: 'Museum of Contemplation', mode: 'Convoy', boardMapId: 'museum-of-contemplation-convoy' },
